...
{
    // [Authorize(Roles = "Admin")] // Puedes descomentar esta línea después para proteger el controlador
    public class UbicacionesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Ciudad,Estado")] Ubicacion ubicacion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Ciudad,Estado")] Ubicacion ubicacion)
        {
            if (id != ubicacion.Id)
            {
                return NotFound();
